            ...
            <div class="inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <?php foreach (get_post_types(['public' => true], 'objects') as $postType): ?>
                                <label>
                                    <input type="checkbox"
                                           name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[post_types][]"
                                           value="<?= esc_attr($postType->name) ?>"
                                           <?php checked(in_array($postType->name, $pluginConfig->postTypes())); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[track_logged_in_users]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[track_logged_in_users]"
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[show_excerpt]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[show_excerpt]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[show_thumbnail]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[show_thumbnail]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[excerpt_length]"
                                   value="<?= esc_attr($pluginConfig->excerptLength()) ?>"
            ...
            <div class="inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[require_consent]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[require_consent]"
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[consent_message]"
                                      rows="2" class="large-text"><?= esc_textarea($pluginConfig->consentMessage()) ?></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[consent_checkbox_label]"
                                   value="<?= esc_attr($pluginConfig->consentCheckboxLabel()) ?>"
                                   class="regular-text">
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[viewed_enabled]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[viewed_enabled]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[max_viewed]"
                                   value="<?= esc_attr($pluginConfig->maxViewed()) ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[label_continue]"
                                   value="<?= esc_attr($pluginConfig->labelContinue()) ?>"
                                   class="regular-text">
                        </td>
                    </tr>
                </table>
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[completed_enabled]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[completed_enabled]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[read_threshold]"
                                   value="<?= esc_attr($pluginConfig->readThreshold()) ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[max_read]"
                                   value="<?= esc_attr($pluginConfig->maxRead()) ?>"
                                   min="1" max="20" class="small-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[label_completed]"
                                   value="<?= esc_attr($pluginConfig->labelCompleted()) ?>"
                                   class="regular-text">
                        </td>
                    </tr>
                </table>
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="number"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[max_suggestions]"
                                   value="<?= esc_attr($pluginConfig->maxSuggestions()) ?>"
                                   min="1" max="20" class="small-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[label_suggestions]"
                                   value="<?= esc_attr($pluginConfig->labelSuggestions()) ?>"
                                   class="regular-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="number"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[suggestions_cache_hours]"
                                   value="<?= esc_attr($pluginConfig->suggestionsCacheHours()) ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[suggestion_order]">
                        ...
                        <td>
                            <fieldset>
                                <?php foreach ($categories as $category): ?>
                                    <label>
                                        <input type="checkbox"
                                               name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[include_categories][]"
                                               value="<?= esc_attr($category->term_id) ?>"
                                               <?php checked(in_array($category->term_id, $pluginConfig->includeCategories())); ?>>
                        ...
                        <td>
                            <fieldset>
                                <?php foreach ($categories as $category): ?>
                                    <label>
                                        <input type="checkbox"
                                               name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[exclude_categories][]"
                                               value="<?= esc_attr($category->term_id) ?>"
                                               <?php checked(in_array($category->term_id, $pluginConfig->excludeCategories())); ?>>
                                        <?= esc_html($category->name) ?>
                                    </label><br>
                                <?php endforeach; ?>
                            </fieldset>
            ...
            <div class="inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[label_empty]"
                                   value="<?= esc_attr($pluginConfig->labelEmpty()) ?>"
                                   class="regular-text">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[label_loading]"
                                   value="<?= esc_attr($pluginConfig->labelLoading()) ?>"
                                   class="regular-text">
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="hidden"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[show_clear_button]"
                                   value="0">
                            <label>
                                <input type="checkbox"
                                       name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[show_clear_button]"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"
                                   name="<?= \Completionist\WordPress\PluginConfigRepository::OPTION_KEY ?>[label_clear]"
                                   value="<?= esc_attr($pluginConfig->labelClear()) ?>"
                                   class="regular-text">
                        </td>
                    </tr>
                </table>
